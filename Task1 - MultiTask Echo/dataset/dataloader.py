...
import random
import torchvision
from utils import loadvideo # Load Video Function
...
file_names = [] # Used for debugging purposes
...
class Echo(torchvision.datasets.VisionDataset):
    ...
    def __init__(self, root=None,
        ...
        if root is None:
            root = "Task1 - MultiTask Echo/dataset/DatasetPediatric"
...
#             # Check that files are present
            ...
            print("All the Video Files Count: ",len(self.fnames))
            file_names.append(self.fnames)
            file_names.append(self.frames)
            keep = [len(self.frames[f]) >= 2 for f in self.fnames]
            self.fnames = [f for (f, k) in zip(self.fnames, keep) if k]
            print("All the Correct Video Files Counts : ",len(self.fnames))
